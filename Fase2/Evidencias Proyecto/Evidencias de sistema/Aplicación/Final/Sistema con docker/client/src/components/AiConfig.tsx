...
const AiConfig: React.FC<AiConfigProps> = () => {
    ...
    const getConfidence = async () =>{
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_EXPRESS_SERVER_URL}/db/getUserConfidence`, {
                method: 'GET',
                credentials: 'include',
                headers: {
    ...
    const setConfidence = async () => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_EXPRESS_SERVER_URL}/api/setConfidence`, {
                method: 'POST',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json',
