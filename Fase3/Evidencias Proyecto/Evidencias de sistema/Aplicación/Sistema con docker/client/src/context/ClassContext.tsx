...
export const ClassProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const fetchCameraLink = async () => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_EXPRESS_SERVER_URL}/db/getCameraLink`, {
                method: 'POST',
                credentials: 'include',
                headers: { 'Content-Type': 'application/json' },
            ...
            await fetch(`${process.env.NEXT_PUBLIC_EXPRESS_SERVER_URL}/api/setCamLink`, {
                method: 'POST',
                credentials: 'include',
                headers: { 'Content-Type': 'application/json' },
